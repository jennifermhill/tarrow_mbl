...
import tarrow
from tarrow.models import TimeArrowNet, model
...
def main(args):
    ...
    checkpoint_path = "/groups/sgro/sgrolab/jennifer/tarrow_mbl/scripts/runs/09-01-14-49-51_dicty_annotation_sampling_backbone_unet/checkpoints/epoch_00030_state.pt"
